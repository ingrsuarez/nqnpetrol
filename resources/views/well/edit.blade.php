        ...
        <div class="bg-color-transparent" id="accordionExample">
            <div
              ...
              <div
                ...
                <div class="px-5 py-4">
                    <form class="" action="{{route('well.update')}}" method="POST">
                        @csrf                
                        ...
                        <div class="mx-2 mt-4 flex flex-wrap">
                            ...
                            <div class="m-2 border-slate-400 border-2 rounded-lg justify-items-stretch flex">
                                ...
                                <input type="text" name="oilfield" id="oilfield" required value="{{$well->oilfield}}"
                            ...
                            <div class="m-2 h-fit border-slate-400 border-2 rounded-lg justify-items-stretch flex">
                                ...
                                text-gray-900 shadow-sm  placeholder:text-gray-400 focus:ring-2 focus:ring-indigo-600" required>
                                    <option value="{{$well->client_id}}"selected>{{ucwords($well->client->name)}}</option>
                                    @foreach ($clients as $client)
                                        @if($client->id <> $well->client_id)
