                    ...
                    <nav class="absolute z-40 flex items-center justify-between bg-sky-700 h-20 lg:gap-12 w-screen">
                        ...
                        >
                            ...
                            <div class="w-36 flex items-center justify-center shadow-2xl ">
                                <img class="m-2 rounded-md hover:scale-90 " src="{{asset('img/brand/logo-white.png')}}" alt="NQN PETROL">
        ...
        class="flex flex-col items-center bg-neutral-200 text-center text-white dark:bg-neutral-600">
            ...
            <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <div class="md:text-center">
                    <h2 class="font-display text-3xl tracking-tight text-slate-600 sm:text-4xl drop-shadow-lg">
                        <span class="relative whitespace-nowrap">
                            <svg aria-hidden="true" viewBox="0 0 281 40" preserveAspectRatio="none" class="absolute opacity-50 left-0 top-1/2 h-[1em] w-full fill-blue-400">
            ...
            <!-- -->a través de nuestros medios de comunicación.
                    </h2>
                </div>
            </div>
            ...
            © 2023 Copyright:
            <a
                class="float-right mr-20 text-neutral-800 dark:text-neutral-400"
                href="#"
                >Rodrigo Suarez</a
            >
            </div>
